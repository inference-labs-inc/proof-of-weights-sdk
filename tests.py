...
class Test_Proof_of_Weights(unittest.TestCase):
    ...
    def setUpClass(cls):
        ...
        cls.api_process = subprocess.Popen(["uvicorn", "main:app", "--host", "localhost", "--port", "8000"], env=env)
        os.chdir("..")
        time.sleep(1)
        # create test wallet
    ...
    def test_send(self):
        pow = proof_of_weights.Proof_Of_Weights("test_wallet", "test_wallet_hotkey", "null", 1)
